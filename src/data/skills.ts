export const categories = [
  {
    ...
    color: '#00ff88',
    skills: [
      { name: 'Python',     level: 95, note: 'Primary — ML, APIs, scripting, data anaalysis'  },
      { name: 'JavaScript', level: 75, note: 'React, Node, Next.js, full-stack'      },
      { name: 'TypeScript', level: 72, note: 'Type-safe frontend & backend'          },
      { name: 'C',        level: 85, note: 'DSA, competitive programming'          },
      { name: 'Java',       level: 75, note: 'OOP fundamentals, basic concepts'      },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'TensorFlow',       level: 85, note: 'Model building, Keras, deployment'     },
  ...
  },
  {
    ...
    color: '#0ea5e9',
    skills: [
      { name: 'React / Next.js', level: 78, note: 'SSR, app router, reusable components' },
      ...
      { name: 'TailwindCSS',     level: 70, note: 'Utility-first, responsive, fast'       },
